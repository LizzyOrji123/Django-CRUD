...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Lizzy\Documents\GitHub\Django-CRUD\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Lizzy\Documents\GitHub\Django-CRUD\env\Scripts\deactivate.nu'
